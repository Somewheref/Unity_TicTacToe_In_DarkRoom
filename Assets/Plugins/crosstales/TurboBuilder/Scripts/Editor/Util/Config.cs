...
namespace Crosstales.TPB.Util
{
   ...
   public static class Config
   {
      ...
      */
      ...
      /// <summary>Enable or disable the PS5 platform.</summary>
      public static bool PLATFORM_PS5;
...
*/
      ...
      /// <summary>Enable or disable 'BuildOptions.CompressWithLz4'.</summary>
      public static CompressionData BO_DATA_COMPRESSION = Constants.DEFAULT_BO_DATA_COMPRESSION;

      /// <summary>Enable or disable 'BuildOptions.DetailedBuildReport'.</summary>
      public static bool BO_DETAILED_BUILD_REPORT = Constants.DEFAULT_BO_DETAILED_BUILD_REPORT;
      ...
      */
      ...
      public static string PATH_BUILD
      {
         get
         {
            //Debug.Log(pathCache + " - " + FileHelper.ValidatePath(pathCache));

            string res = CUSTOM_PATH_BUILD && !string.IsNullOrEmpty(pathCache) ? FileHelper.ValidatePath(pathCache) : Constants.DEFAULT_PATH_CACHE;
      ...
      public static void Reset()
      {
         ...
         */
         ...
         BO_DATA_COMPRESSION = Constants.DEFAULT_BO_DATA_COMPRESSION;
         BO_DETAILED_BUILD_REPORT = Constants.DEFAULT_BO_DETAILED_BUILD_REPORT;
      ...
      public static void Load()
      {
         ...
         */
         ...
         if (CTPlayerPrefs.HasKey(Constants.KEY_PLATFORM_PS5))
            PLATFORM_PS5 = CTPlayerPrefs.GetBool(Constants.KEY_PLATFORM_PS5);
...
*/
         ...
         if (CTPlayerPrefs.HasKey(Constants.KEY_BO_DATA_COMPRESSION))
            BO_DATA_COMPRESSION = (CompressionData)CTPlayerPrefs.GetInt(Constants.KEY_BO_DATA_COMPRESSION);

         if (CTPlayerPrefs.HasKey(Constants.KEY_BO_DETAILED_BUILD_REPORT))
            BO_DETAILED_BUILD_REPORT = CTPlayerPrefs.GetBool(Constants.KEY_BO_DETAILED_BUILD_REPORT);
      ...
      public static void Save()
      {
         ...
         */
         ...
         CTPlayerPrefs.SetBool(Constants.KEY_PLATFORM_PS5, PLATFORM_PS5);
         ...
         CTPlayerPrefs.SetInt(Constants.KEY_BO_DATA_COMPRESSION, (int)BO_DATA_COMPRESSION);
         CTPlayerPrefs.SetBool(Constants.KEY_BO_DETAILED_BUILD_REPORT, BO_DETAILED_BUILD_REPORT);
      ...
      private static void setupPlatforms()
      {
         ...
         PLATFORM_PS5 = Helper.isValidBuildTarget(BuildTarget.PS5);
