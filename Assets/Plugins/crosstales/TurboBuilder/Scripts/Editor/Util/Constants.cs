...
*/
      ...
      public const string KEY_PLATFORM_PS5 = KEY_PREFIX + "PLATFORM_PS5";
      ...
      public const string KEY_BO_DATA_COMPRESSION = KEY_PREFIX + "BO_DATA_COMPRESSION";
      public const string KEY_BO_DETAILED_BUILD_REPORT = KEY_PREFIX + "BO_DETAILED_BUILD_REPORT";
      ...
      public const CompressionData DEFAULT_BO_DATA_COMPRESSION = CompressionData.Default;
      public const bool DEFAULT_BO_DETAILED_BUILD_REPORT = false;
      ...
      /// <summary>Text for builds with the "BuildOptions.Development" option.</summary>
      public static string TEXT_DEVELOPMENT = "DEV";

      #endregion
   }

   public enum CompressionData
   {
      Default,
      LZ4,
      LZ4HC,
