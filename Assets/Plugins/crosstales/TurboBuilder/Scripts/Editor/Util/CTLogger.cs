...
namespace Crosstales.TPB.Util
{
   ...
   {
      private static readonly string fileMethods = Crosstales.Common.Util.FileHelper.TempPath + "TPB_Methods.log";
      private static readonly string fileLog = Crosstales.Common.Util.FileHelper.TempPath + "TPB.log";
