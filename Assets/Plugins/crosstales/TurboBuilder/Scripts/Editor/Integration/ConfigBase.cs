...
*/
      ...
      private static bool platformPS5;
...
*/
         ...
         platformPS5 = Helper.isValidBuildTarget(BuildTarget.PS5);
      ...
      protected void showConfiguration()
      {
         ...
         scrollPosPlatforms = EditorGUILayout.BeginScrollView(scrollPosPlatforms, false, false);
         {
               ...
               EditorGUILayout.BeginHorizontal();
               {
                  ...
                  if (GUILayout.Button(new GUIContent(" Select", Helper.Icon_Folder, "Select path for the builds")))
                  {
                     ...
                     if (!string.IsNullOrEmpty(path))
                        Config.PATH_BUILD = Common.Util.FileHelper.isRoot(path) ? path + Constants.BUILD_DIRNAME : path + "/" + Constants.BUILD_DIRNAME;
                  }
               }
            ...
            */
            ...
            Config.BO_DATA_COMPRESSION = (CompressionData)EditorGUILayout.EnumPopup(new GUIContent("Data Compression", "Enable or disable 'BuildOptions.CompressWithLz4' (default: " + Constants.DEFAULT_BO_DATA_COMPRESSION + ")."), (Config.BO_DATA_COMPRESSION));
#if UNITY_2020_1_OR_NEWER
            Config.BO_DETAILED_BUILD_REPORT = EditorGUILayout.Toggle(new GUIContent("Detailed Build Report", "Enable or disable 'BuildOptions.DetailedBuildReport' (default: " + Constants.DEFAULT_BO_DETAILED_BUILD_REPORT + ")."), Config.BO_DETAILED_BUILD_REPORT);
#endif
            Helper.SeparatorUI();
            ...
            if (platformPS5)
               Config.PLATFORM_PS5 = EditorGUILayout.Toggle(new GUIContent("PS5", "Enable or disable the support for the Sony PS5 platform."), Config.PLATFORM_PS5);
...
*/
      ...
      private static void drawColumnZebra()
      {
         ...
         if (Config.PLATFORM_PS5 && platformPS5)
            drawZebra(BuildTarget.PS5);
...
*/
      ...
      private static void drawColumnAction()
      {
         GUILayout.BeginVertical();
         {
            ...
            if (Config.PLATFORM_PS5 && platformPS5)
               drawAction(BuildTarget.PS5, Helper.Logo_Ps5);
